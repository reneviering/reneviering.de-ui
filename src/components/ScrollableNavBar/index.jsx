...
const withScrollHandling = ComposedComponent =>
    ...
    render() {
      return (
        <ComposedComponent
          ...
          color={`rgba(${255 * (1 - this.state.opacity)}, ${255 *
            (1 - this.state.opacity)}, ${255 * (1 - this.state.opacity)}, 1)`}
          backgroundColor={`rgba(255, 255, 255, ${this.state.opacity})`}
          boxShadow={`rgba(0, 0, 0, ${0.2 *
            this.state.opacity}) 0px 2px 5px 0px`}
        />
      );
    }
  };
